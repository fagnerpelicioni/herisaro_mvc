...
function modal( endereco, titulo, tamanho, variaveis){
	...
	if(tamanho == 'grande'){
		$('#modal_conteudo_g').html("<div style='text-align:center;'><img src='"+dominio()+"img/loading.gif' style='width:25px;'></div>");
		$('#janela_modal_grande').modal();
	} else {
		$('#modal_conteudo_m').html("<div style='text-align:center;'><img src='"+dominio()+"img/loading.gif' style='width:25px;'></div>");
